...
//  2. CIE D65, D50 and D60 spectra sampled at 5nm intervals,
...
pub(crate) static ILLUMINANT_D50: [f64; SAMPLES] = [
    ...
    m!(80.599000),
    m!(78.274000),
    // These values are wrong to match the original repo
    m!(0.0),
    m!(0.0),
    m!(0.0),
    m!(0.0),
...
pub(crate) static ILLUMINANT_D60: [f64; SAMPLES] = [
    ...
    o!(60.825601),
    o!(62.987850),
    o!(0.0000000), // This value is wrong to match the original repo
];
